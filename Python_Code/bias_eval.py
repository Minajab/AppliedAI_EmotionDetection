...
def main(args):
    ...
    if not os.path.exists(os.path.join(results_path, 'bias_results')):
        os.mkdir(os.path.join(results_path, 'bias_results'))
    results_path = os.path.join(os.path.join(results_path, 'bias_results'))
    ...
    metadata = pd.read_csv(os.path.join(cwd, '..', 'Meta_Data', 'original_dataset.csv'))
